...
export async function addNationalContest(name, date, start, end) {
...
export async function createTeam(
  name,
  member1, member2,member3, member4,member5, member6, member7,member8, member9, member10,member11, member12, member13,member14,member15,  coach,
  contest
) {
  return await Axios.post("http://localhost:3001/contests/createTeam", {
    ...
    member2: member2,
    member3: member3,
    member4,member5, member6, member7,member8, member9, member10,member11, member12, member13,member14,member15,
    coach: coach,
    contest: contest,
  }).then((response) => response.data);
}
